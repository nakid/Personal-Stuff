		<div class="footer">
            ...
            Todas as imagens são de divulgação e de propriedade de suas respectivas marcas. As datas e horários dos eventos podem sofrer altrações sem aviso prévio.</span></p>
				...
				$("#postContato").click(function() {				
					...
					if (err != "" ) {
						...
						$.ajax({
							...
							cache: false,
							data: {
								ctt_nome: nome, ctt_email: email, ctt_txt: txt },
								success: function(data) {
									if (data == "done") {
										$("#formSendStatus").html('Seu contato foi enviado! Responderemos em breve. Muito Obrigado! ');
										var intervalo = window.setTimeout(function(){ $("#formSendStatus").slideUp(200); }, 3000);
									}
